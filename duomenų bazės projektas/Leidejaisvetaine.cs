...
{
    public partial class Leidejaisvetaine : Form
    {
        public Leidejaisvetaine()
        {
            InitializeComponent();
        }
        ...
        public void Leidejaisvetaine_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string query = "SELECT vardas, pavarde, imone, svetaine FROM leidejas";
